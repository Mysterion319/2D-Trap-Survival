...
using UnityEngine;
/**
* Then looking at the final boss script i am able to add the weapon to the 
...
public class FinalBoss : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject EnergyBlast;//name of the weapon to link the prefab to the skelenton.
    ...
    void CheckIfTimeToFire()
    {
        ...
        {
            Instantiate(EnergyBlast, transform.position, Quaternion.identity);//The weapon getting the postion and the quaternion.
