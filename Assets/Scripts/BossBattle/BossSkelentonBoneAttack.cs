...
*/
public class BossSkelentonBoneAttack : MonoBehaviour
{
    float SkelentonSpeed = 7f;//Set speed of skelenton.
    ...
    void Start()
    {
        ...
        moveDirection = (target.transform.position - transform.position).normalized * SkelentonSpeed;//Moves the weapon the speed of the skelenton.
